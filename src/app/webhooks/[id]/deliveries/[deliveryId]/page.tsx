    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-5 space-y-4">
        <div>
          ...
          <pre className="text-xs bg-gray-900 text-yellow-300 rounded-lg p-4 overflow-x-auto whitespace-pre-wrap break-words">{delivery.canonicalBody}</pre>
        </div>
        <div>
          ...
          <pre className="text-xs bg-gray-900 text-green-400 rounded-lg p-4 overflow-x-auto whitespace-pre-wrap break-words">{delivery.requestBody}</pre>
        </div>
        <div>
          <h2 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Request headers</h2>
          <pre className="text-xs bg-gray-900 text-blue-300 rounded-lg p-4 overflow-x-auto whitespace-pre-wrap break-words">{delivery.requestHeaders}</pre>
        </div>
      </div>
